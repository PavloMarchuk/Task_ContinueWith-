...
namespace _04_Cancelation_Employee
{
	...
	{
		public static List<Employee> GetEmployee(object ct)
		{
			...
			{
				Console.WriteLine("ЗАПИТ НА ЗАВЕРШЕННЯ 1");
		...
		public static void PrintEmployee(IEnumerable<Employee> collection, object ct)
		{
			CancellationToken token = (CancellationToken)ct;
			token.ThrowIfCancellationRequested();
